...
class Legend extends Element implements ConfigMigrationInterface
{
    ...
    public function getConfiguration()
    {
        ...
        $dynamicLegendsMapping = $this->getDynamicLegendsMapping();
        $configuration['dynamic-legends'] = $dynamicLegendsMapping;

        return $configuration; // TODO: Change the autogenerated stub
    }
